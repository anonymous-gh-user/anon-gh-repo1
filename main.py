...
from src.train_resnet import ResNetExperiment
from src.run_qwenvl import Qwen2VLExperiment
...
PROJ_DIR = "~/projects/aip-anonlab/ANON-USER/medcbr"
...
class Main:
    ...
    def __call__(self):
        ...
        CKPT_DIR = f'/scratch/ANON-USER/ckpt'
        ...
        # ResNet baseline
        if conf.mode == "resnet":
            experiment = ResNetExperiment(conf)
        # CBM Baseline
        elif "cbm-base" in conf.mode:
        ...
        # Large Language Models
            ...
            experiment = Qwen2VLExperiment(conf)
