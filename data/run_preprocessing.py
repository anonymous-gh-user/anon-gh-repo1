...
def crop_breast_us_images(dataset_name, src_dir, dst_dir):
    ...
    data_dir = src_dir if src_dir else f'/h/ANON-USER/medcbr/data/{dataset_name}'
    cropped_dir = dst_dir if dst_dir else f'/h/ANON-USER/medcbr/data/{dataset_name}_cropped'
    os.makedirs(cropped_dir, exist_ok=True)

    meta = pd.read_csv(f'/h/ANON-USER/medcbr/data/{dataset_name}/metadata.csv')
    new_meta_name = f'/h/ANON-USER/medcbr/data/{dataset_name}_cropped/metadata.csv'
